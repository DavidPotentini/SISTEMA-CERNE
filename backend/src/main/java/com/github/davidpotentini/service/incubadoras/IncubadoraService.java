...
/**
 * Opera no schema {@code public}. A criação gera o {@code NOME_SCHEMA} e nasce em
 * {@code AGUARDANDO_ATIVACAO}; o schema do tenant só é provisionado na primeira ativação.
 */
@Service
public class IncubadoraService {
    ...
    /** Na primeira ativação, provisiona o schema do tenant e marca {@code ativadaEm}. */
    @Transactional(rollbackFor = Exception.class)
    ...
    /** Slug válido como schema Postgres ({@code ^[a-z0-9_]+$}), único e ≤ 63 chars. */
